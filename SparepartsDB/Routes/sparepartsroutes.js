...
// Search for products by a list of parts
...
router.post("/product-list", async (req, res) => {
    try {
        ...
        // Map over the input parts array to preserve order
        const result = validParts.map(part => {
            const key = part.toLowerCase();
            return productMap[key] || { name: part, id: null, url: null, image: null };
        });
